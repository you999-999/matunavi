/**
 * まつなび - プライバシーポリシーページ（Privacy Policy）
 * 
 * このファイルは、まつなびのプライバシーポリシーを表示する法的文書ページです。
 * 
 * 【目的】
 * - 個人情報の取り扱い方針を明示
 * - Cookie使用について説明
 * - 第三者サービス（AdSense、Analytics）の利用を開示
 * - ユーザーのプライバシー権利を保護
 * - 法令遵守（個人情報保護法等）
 * 
 * 【ポリシーの構成（全8項目）】
 ...
 * 
 * 3. 広告について
 *    - Google AdSense等の第三者広告を使用
 *    - Cookie を使用した行動ターゲティング広告
 *    - ユーザーによる Cookie 無効化の選択肢
 * 
 * 4. アクセス解析ツールについて
 *    - Google Analytics 等の使用
 *    - 個人を特定しないトラフィックデータの収集
 * 
 * 5. 第三者への情報提供
 *    - 法令に基づく場合を除き提供しない
 * 
 ...
 * 【法的重要性】
 * - 個人情報保護法への対応
 * - Google AdSense ポリシー要件への準拠
 * - ユーザーの信頼獲得
 * - プライバシー侵害リスクの軽減
 * 
 * 【第三者サービス】
 * - Google AdSense（広告配信）
 * - Google Analytics（アクセス解析）- 使用する場合
 * 
 * 【デザインパターン】
 * - 見出しは h1（タイトル）、h2（各項目）
 * - 箇条書きで情報を整理
